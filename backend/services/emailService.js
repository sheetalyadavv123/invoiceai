...
<body style="margin:0;padding:0;background:#f5f5f5;font-family:'Segoe UI',Arial,sans-serif">
  <div style="max-width:600px;margin:32px auto;background:#ffffff;border-radius:16px;overflow:hidden">
    ...
    <div style="padding:36px 40px">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:20px;border:1px solid #e5e7eb">
        <thead>
          <tr style="background:#7c3aed">
            <th style="padding:10px 16px;text-align:left;color:#fff;font-size:11px">Description</th>
            <th style="padding:10px 16px;text-align:center;color:#fff;font-size:11px">Qty</th>
            <th style="padding:10px 16px;text-align:right;color:#fff;font-size:11px">Price</th>
            <th style="padding:10px 16px;text-align:right;color:#fff;font-size:11px">Total</th>
          </tr>
        </thead>
      ...
      <p style="color:#6b7280;font-size:13px">Invoice PDF is attached. Please pay by <strong>${dueDate}</strong>.</p>
    </div>
    <div style="background:#1a1035;padding:24px 40px;text-align:center">
      <div style="color:#a78bfa;font-size:12px">Generated by Invoi</div>
    </div>
  </div>
</body>
</html>`;
    ...
    await resend.emails.send({
      from: 'Invoi <onboarding@resend.dev>',
      to: client.email,
      subject: `Invoice ${invoiceNum} — due on ${dueDate}`,
      html,
      attachments: [{
