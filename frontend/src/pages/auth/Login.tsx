        ...
        <div style={styles.leftContent}>
          ...
          <div style={styles.illustration}>
            <svg width="280" height="220" viewBox="0 0 280 220" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="30" y="100" width="60" height="3" rx="1.5" fill="rgba(167,139,250,0.2)" />
              ...
              <rect x="122" y="118" width="60" height="3" rx="1.5" fill="rgba(167,139,250,0.2)" />
              ...
              {/* Floating dots */}
              <circle cx="260" cy="30" r="4" fill="rgba(167,139,250,0.5)" />
              <circle cx="15" cy="140" r="3" fill="rgba(139,92,246,0.4)" />
              <circle cx="270" cy="150" r="5" fill="rgba(109,40,217,0.4)" />
            </svg>
          </div>

          <div style={styles.tagline}>
            <h2 style={styles.taglineHeading}>Invoicing,<br />reimagined with AI.</h2>
            <p style={styles.taglineSub}>Smart reminders. Instant insights.<br />Zero manual work.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
            ...
            <div style={styles.fieldGroup}>
              ...
              <div style={styles.passwordWrap}>
                ...
                >
                  {showPassword ? (
                    <svg width="18" height="18" fill="none" stroke="#9ca3af" strokeWidth="2" viewBox="0 0 24 24"><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                  ) : (
...
const styles: Record<string, React.CSSProperties> = {
  ...
  leftPanel: {
    ...
    position: 'relative',
    overflow: 'hidden',
    background: 'linear-gradient(135deg, #0d0a1a 0%, #1a0f2e 50%, #120826 100%)',
    display: 'flex',
    alignItems: 'center',
  ...
  rightPanel: {
    ...
    justifyContent: 'center',
    padding: '40px',
    background: 'linear-gradient(160deg, #0f0b1f 0%, #0d0a1a 100%)',
  },
  formCard: {
    width: '100%',
    maxWidth: '400px',
